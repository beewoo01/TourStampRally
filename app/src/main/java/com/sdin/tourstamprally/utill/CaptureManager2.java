...
public class CaptureManager2 {
    private static final String TAG = CaptureManager2.class.getSimpleName();
    ...
    private final CameraPreview.StateListener stateListener = new CameraPreview.StateListener() {
        ...
        public void cameraError(Exception error) {
            displayFrameworkBugMessageAndExit(
                    fragment.getString(R.string.zxing_msg_camera_framework_bug)
    ...
    public CaptureManager2(Fragment fragment, DecoratedBarcodeView barcodeView) {
        ...
        inactivityTimer = new InactivityTimer(fragment.getContext(), ()-> {
        ...
        beepManager = new BeepManager(fragment.getActivity());
    ...
    protected void lockOrientation() {
        ...
        if (this.orientationLock == ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED) {
            ...
            int baseOrientation = fragment.getActivity().getResources().getConfiguration().orientation;
            int orientation = 0;
        ...
        fragment.getActivity().setRequestedOrientation(this.orientationLock);
    }
    ...
    private String getBarcodeImagePath(BarcodeResult rawResult) {
        ...
        if (returnBarcodeImagePath) {
            ...
            try {
                ...
                File bitmapFile = File.createTempFile("barcodeimage", ".jpg", fragment.getActivity().getCacheDir());
    ...
    private void setMissingCameraPermissionResult() {
        ...
        fragment.getActivity().setResult(Activity.RESULT_CANCELED, intent);
    ...
    protected void displayFrameworkBugMessageAndExit(String message) {
        ...
        if (fragment.getActivity().isFinishing() || this.destroyed || finishWhenClosed) {
            return;
        }

        if (message.isEmpty()) {
            //message = activity.getString(R.string.zxing_msg_camera_framework_bug);
            message = fragment.getActivity().getString(R.string.zxing_msg_camera_framework_bug);
        }

        //AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        AlertDialog.Builder builder = new AlertDialog.Builder(fragment.getActivity());
        //builder.setTitle(activity.getString(R.string.zxing_app_name));
        builder.setTitle(fragment.getActivity().getString(R.string.zxing_app_name));
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        CaptureManager2.cameraPermissionReqCode = cameraPermissionReqCode;
    }
