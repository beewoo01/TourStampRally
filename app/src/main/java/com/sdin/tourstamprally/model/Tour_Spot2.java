...
public class Tour_Spot2 implements Comparable<Tour_Spot>, Serializable {
    ...
    public Tour_Spot2(int location_idx, String location_name, String location_img, String location_createtime, String locatio_updatetime,
                      int touristspot_idx, int touristspot_location_location_idx, String touristspot_name, String touristspot_explan,
                      double touristspot_latitude, double touristspot_longitude, String touristspot_img, String touristspot_tag,
                      int touristspot_checkin_count, String touristspot_createtime, String touristspot_updatetime, String touristspotpoint_idx,
                      String touristspotpoint_touristspot_idx, String touristspotpoint_name, String touristspotpoint_explan,
                      String touristspotpoint_latitude, String touristspotpoint_longitude, String touristhistory_idx,
                      String touristhistory_touristspotpoint_idx, String touristhistory_user_idx, String touristhistory_createtime,
                      String touristhistory_updatetime, int location_percentage, int tourspot_percentage, int location_clearPercent,
                      int tourspot_clearPercent, boolean clear, int user_touristspot_interest_idx, int interest_user_idx,
                      int interest_touristspot_idx, String interest_createtime, String interest_updatetime) {
    ...
    public String getTouristspot_createtime() {
        return touristspot_createtime;
    }

    public void setTouristspot_createtime(String touristspot_createtime) {
        this.touristspot_createtime = touristspot_createtime;
    }

    public String getTouristspot_updatetime() {
        return touristspot_updatetime;
    }

    public void setTouristspot_updatetime(String touristspot_updatetime) {
        this.touristspot_updatetime = touristspot_updatetime;
    }
    ...
    public String getTouristhistory_createtime() {
        return touristhistory_createtime;
    }

    public void setTouristhistory_createtime(String touristhistory_createtime) {
        this.touristhistory_createtime = touristhistory_createtime;
    }
