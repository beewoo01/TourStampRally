...
public class GetStamp2Fragment extends Fragment {

    private TextView tvtitle;

    public static GetStamp2Fragment newInstance(int num) {
        GetStamp2Fragment fragment = new GetStamp2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_get_stamp2, container, false);
